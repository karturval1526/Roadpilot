...
La URL ya está configurada para el proyecto Supabase de RoadPilot:
`https://dnzyqvqsnhwjlrcefxsx.supabase.co`
...
La política pública está disponible en `privacy.html`. En GitHub Pages quedará en:

`https://karturval1526.github.io/Roadpilot/privacy.html`

Esta página se puede registrar como **Privacy Policy URL** en el panel de Uber.
